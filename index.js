...
const inputs = document.querySelector(".word"), // Selecting/Accessing/Retrieving elements with class "word"
    ...
    resetBtn = document.querySelector(".reset"), // Selecting/Accessing/Retrieving element with class "reset"
...
resetBtn.addEventListener("click", startNewGame); // Adding a click event listener to the reset button
